...
LINK=$(CXX)
AR=ar
DEFS=-DPACKAGE_NAME=\"abm\" -DPACKAGE_TARNAME=\"abm\" -DPACKAGE_VERSION=\"1.0\" -DPACKAGE_STRING=\"abm\ 1.0\" -DPACKAGE_BUGREPORT=\"support@revenco.com\" -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE_STRING_H=1
